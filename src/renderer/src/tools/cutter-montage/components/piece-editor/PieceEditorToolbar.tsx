  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <ToolButton
        ...
        icon={Circle}
      />
      <Button type="button" size="sm" variant="outline" onClick={props.onZoomIn}>
        <ZoomIn data-icon="inline-start" />
        Zoom
      </Button>
      <Button type="button" size="sm" variant="outline" onClick={props.onZoomOut}>
        <ZoomOut data-icon="inline-start" />
        Zoom
      </Button>
      <Button type="button" size="sm" variant="outline" onClick={props.onFit}>
